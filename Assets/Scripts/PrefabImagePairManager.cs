    ...
    public class PrefabImagePairManager : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        void OnTrackedImagesChanged(ARTrackedImagesChangedEventArgs eventArgs)
        {
            ...
            foreach (var trackedImage in eventArgs.added)
            {
                ...
                Logger.Log("OnTrackedImagesChanged" );
        ...
        void AssignPrefab(ARTrackedImage trackedImage)
        {
            ...
            {
                Logger.Log("AssignPrefab-TryGetValue");
        ...
        {
            Logger.Log("SetPrefabForReferenceImage");
        ...
        public void ClearInstance()
        {
            ...
            {
                Destroy(m_Instantiated[key]);
                m_Instantiated.Remove(key);
            }
